...
import {StyleSheet,ViewStyle,TextStyle,GestureResponderEvent} from 'react-native';
...
interface Props {
  ...
  containerStyle?: ViewStyle | TextStyle | string | number|any;
...
const LoggedInHeader: React.FC<Props> = props => {
